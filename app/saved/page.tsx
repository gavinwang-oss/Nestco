          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {listings.map((listing) => {
              ...
              return (
                <div
                  key={listing.id}
                  className="bg-white rounded-2xl border border-black/[0.06] shadow-sm overflow-hidden group"
                >
                  {/* Photo */}
                  <div
                    className={`relative h-40 cursor-pointer ${hasPhoto ? "" : `bg-gradient-to-br ${gradient}`}`}
